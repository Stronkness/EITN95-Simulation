...
//Denna klass rver Proc, det gör att man kan använda time och signalnamn utan punktnotation
...
class Gen extends Proc{
	...
	//Hur nedan anger man vad som ska göras när en signal kommer //What to do when a signal arrives
